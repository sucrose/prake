<?php
    class proxyserverspro {
        ...
        public function get_proxies($user_agent) {
            $arr = [];
            $pages = 3; // # of pages to rake [max: 3]
            for ($page = 1;$page <= $pages; $page++) {
                $resp = $this->curl_get("https://proxyservers.pro/proxy/list/protocol/https/country/US/order/updated/order_dir/desc/page/$page", $user_agent);
                $re = '/chash = \'(?<chash>.*)\'/mU';
